...
birthday.prob = function(n.pers, n.sims) {
  ...
  all.different = (lapply(unique.birthdays, 
                          length) == n.pers)
...
## Hands-on excercise #2: Mostly Harmless Econometrics! (@WB?)

There is a [fantastic Github](https://github.com/vikjam/mostly-harmless-replication) repo that is reproducing results from MHE (Originated here?)
